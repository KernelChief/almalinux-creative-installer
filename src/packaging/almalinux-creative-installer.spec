...
install -D -m 0755 src/alma-creative-installer %{buildroot}%{_bindir}/alma-creative-installer
install -D -m 0755 src/alma-creative-installer-helper %{buildroot}%{_libexecdir}/alma-creative-installer-helper
...
install -D -m 0644 src/alma-creative-installer.desktop \
  %{buildroot}%{_datadir}/applications/alma-creative-installer.desktop
install -D -m 0644 LICENSE \
  %{buildroot}%{_datadir}/licenses/%{name}/LICENSE

%files
%{_bindir}/alma-creative-installer
%{_libexecdir}/alma-creative-installer-helper
%{_datadir}/polkit-1/actions/org.almalinux.creativeinstaller.policy
%{_datadir}/applications/alma-creative-installer.desktop
